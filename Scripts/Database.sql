...
-- -----------------------------------------------------
-- Table `SAO_DB`.`PROGRAM_COURSES`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `SAO_DB`.`PROGRAM_COURSES` (
  `COURSE_ID` INT NOT NULL,
  `PROGRAM_ID` INT NOT NULL,
  PRIMARY KEY (`COURSE_ID`, `PROGRAM_ID`),
  INDEX `fk_PROGRAM_COURSES_PROGRAM1_idx` (`PROGRAM_ID` ASC) VISIBLE,
  CONSTRAINT `fk_PROGRAM_COURSES_COURSE1`
    FOREIGN KEY (`COURSE_ID`)
    REFERENCES `SAO_DB`.`COURSE` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_PROGRAM_COURSES_PROGRAM1`
    FOREIGN KEY (`PROGRAM_ID`)
    REFERENCES `SAO_DB`.`PROGRAM` (`ID`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
